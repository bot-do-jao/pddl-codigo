(define (problem hotel-prob-2)
    ...
    (:init
        ( = (preco-quartoS quarto-s1) 60)
        ( = (preco-quartoS quarto-s2) 170)
        (= (preco-quartoS quarto-s3) 100)
        ( = (preco-quartoD quarto-C1) 200)
        ( = (preco-quartoD quarto-C2) 280)
        (= (preco-quartoT quarto-T1) 300)
        (= (preco-quartoT quarto-T2) 312)
        (= (preco-quartoQ quarto-Q1) 360)
        (= (orcamento) 1500)
